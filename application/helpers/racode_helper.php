...
// function cmb_dinamis2($name, $table, $field, $pk, $selected = null, $order = null, $name2, $table2)
// {
//     $ci = get_instance();
//     $cmb = "<select name='$name' class='form-control'>";
//     // if ($order) {
//     //     $ci->db->order_by('id_users', $order);
//     // }
//     $x = get_instance()->db->select($name2)
//         ->get($table2);
//     $y = $x->result();
//     // $y = array(2, 3, 7, 8, 9);
//     $data = $ci->db
//         // ->where_not_in($name2, $y)
//         ->where_not_in('id_karyawan', $y, FALSE)
//         ->get($table);
//     // $data = $ci->db->table('karyawan')
//     //     ->select('nama')
