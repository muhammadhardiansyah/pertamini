			...
			<form action="<?php echo $action; ?>" method="post">
				...
				<table class='table table-bordered'>
					<tr>
						...
						<td><input readonly type="text" class="form-control" name="id_karyawan" id="id_karyawan" placeholder="Id Karyawan" value="<?php echo $_SESSION['id_users'] ?>" /></td>
					</tr>
					...
					<tr>
						...
						<td>
							...
							<a href="<?php echo site_url('cuti') ?>" class="btn btn-danger"><i class="fa fa-sign-out"></i> Kembali</a>
						</td>
					</tr>
