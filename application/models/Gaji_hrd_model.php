...
class Gaji_hrd_model extends CI_Model
{
    ...
    function json()
    {
        ...
        $this->datatables->add_column('action', anchor(site_url('gaji_hrd/print/$1'), '<i class="fa fa-print" aria-hidden="true"></i>', array('class' => 'btn btn-primary btn-sm', 'id' => 'cetakButton')) . " 
                ", 'no_slip');
