...
class User_level_model extends CI_Model
{
    ...
    function json()
    {
        ...
        $this->datatables->add_column('action', anchor(site_url('userlevel/akses/$1'), '<i class="fa fa-edit" aria-hidden="true"></i>', array('class' => 'btn btn-primary btn-sm')) . " 
            " . anchor(site_url('userlevel/update/$1'), '<i class="fa fa-pencil-square-o" aria-hidden="true"></i>', array('class' => 'btn btn-warning btn-sm')) . " 
